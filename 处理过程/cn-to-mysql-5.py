...
class BeautifulPicture():
    ...
    def request(self, url):  # 返回网页的response
        ...
        cookie = 'WFKS.Auth=%7b%22Context%22%3a%7b%22AccountIds%22%3a%5b%5d%2c%22Data%22%3a%5b%5d%2c%22Ses' \
                 'sionId%22%3a%22f13f8a90-a3e1-4bb9-9915-28e27bd05c42%22%2c%22Sign%22%3a%22hi+authserv%22%7d%' \
                 '2c%22LastUpdate%22%3a%222017-06-06T'+H+'%3a'+M+'%3a23Z%22%2c%22TicketSign%22%3a' \
                 '%22e71EVk9%2bzFJs5SUkSggHrQ%3d%3d%22%7d'

        headers = {'User-Agent': user_agent,
                   "Referer": referer,
                   "cookie": cookie}
        r = requests.get(url, headers=headers, timeout=100, proxies="218.4.101.130:83")
        return r
